...
var UserWhere = struct {
	...
	Contact:   whereHelperstring{field: "\"users\".\"contact\""},
...
var (
	userAllColumns            = []string{"id", "username", "firstname", "lastname", "email", "contact", "created_at", "deleted_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "firstname", "lastname", "email", "contact"}
	userColumnsWithDefault    = []string{"id", "created_at", "deleted_at", "updated_at"}
